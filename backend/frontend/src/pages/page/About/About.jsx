      ...
      <div class="flex justify-center">
        <form class="w-1/2">
          <div class="mb-4">
            ...
            <input type="text" id="name" class="border border-gray-400 py-2 px-4 rounded w-full focus:outline-none focus:border-blue-500"/>
          </div>
          <div class="mb-4">
            <label class="block text-gray-600 font-bold mb-2" for="email">Email</label>
            <input type="email" id="email" class="border border-gray-400 py-2 px-4 rounded w-full focus:outline-none focus:border-blue-500"/>
          </div>
          <div class="mb-4">
            <label class="block text-gray-600 font-bold mb-2" for="message">Message</label>
            <textarea id="message" class="border border-gray-400 py-2 px-4 rounded w-full focus:outline-none focus:border-blue-500"></textarea>
          </div>
